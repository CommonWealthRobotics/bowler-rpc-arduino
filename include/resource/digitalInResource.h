 ...
 */
#ifndef DIGITALINRESOURCE_H
#define DIGITALINRESOURCE_H
...
namespace bowlerrpc {
class DigitalInResource : public Resource {
  public:
  DigitalInResource(const bool iisReliable) : Resource(iisReliable) {
  }
 ...
 */
static std::uint8_t validateDigitalInAttachmentData(const std::uint8_t *attachmentData) {
